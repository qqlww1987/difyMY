...
const baseFetchNew = <T>(
  ...
  options.headers.set('Content-Type', ContentType.download)
...
export const requestNew = <T>(url: string, options = {}, otherOptions?: IOtherOptions) => {
  return baseFetchNew<T>(url, options, otherOptions || {})
}
// base request
